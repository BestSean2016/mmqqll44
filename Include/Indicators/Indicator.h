...
public:
   ...
   bool              Create(const string symbol,const ENUM_TIMEFRAMES period,
                            // -- OLD -- const ENUM_INDICATOR type,const int num_params,const MqlParam &params[]);
...
protected:
   ...
   virtual bool      Initialize(const string symbol,const ENUM_TIMEFRAMES period,
                                // -- OLD -- const int num_params,const MqlParam &params[]) {return(false);}
