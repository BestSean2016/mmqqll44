...
#define description "Relative Strength Index"
#define strict
...
#define indicator_color1     DodgerBlue
#define indicator_level1     30.0
#define indicator_level2     70.0
#define indicator_levelcolor clrSilver
#define indicator_levelstyle STYLE_DOT
//--- input parameters
static int InpRSIPeriod=14; // RSI Period
//--- buffers
double ExtRSIBuffer[];
double ExtPosBuffer[];
double ExtNegBuffer[];
