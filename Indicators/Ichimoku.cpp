...
#define description "Ichimoku Kinko Hyo"
#define strict

#define indicator_chart_window
#define indicator_buffers 7
#define indicator_color1 Red          // Tenkan-sen
#define indicator_color2 Blue         // Kijun-sen
#define indicator_color3 SandyBrown   // Up Kumo
#define indicator_color4 Thistle      // Down Kumo
#define indicator_color5 Lime         // Chikou Span
#define indicator_color6 SandyBrown   // Up Kumo bounding line
#define indicator_color7 Thistle      // Down Kumo bounding line
//--- input parameters
static int InpTenkan=9;   // Tenkan-sen
static int InpKijun=26;   // Kijun-sen
static int InpSenkou=52;  // Senkou Span B
//--- buffers
