...
#define description "Bollinger Bands"
#define strict
...
#define indicator_color2 LightSeaGreen
#define indicator_color3 LightSeaGreen
//--- indicator parameters
static int    InpBandsPeriod=20;      // Bands Period
static int    InpBandsShift=0;        // Bands Shift
static double InpBandsDeviations=2.0; // Bands Deviations
//--- buffers
