...
//|                                              http://www.mql4.com |
//+------------------------------------------------------------------+
#define copyright "2007-2014, MetaQuotes Software Corp."
#define link      "http://www.mql4.com"
#define strict

#define indicator_separate_window
#define indicator_buffers 1
#define indicator_minimum 0.0
#define indicator_maximum 0.1
...
static color InpColor=LightSeaGreen;  // Text color
