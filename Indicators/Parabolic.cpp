...
#define description "Parabolic Stop-And-Reversal system"
#define strict

//--- indicator settings
#define indicator_chart_window
#define indicator_buffers 1
#define indicator_color1  Lime
//--- input parameters
static double InpSARStep=0.02;    // Step
static double InpSARMaximum=0.2;  // Maximum
//---- buffers
double       ExtSARBuffer[];
//--- global variables
double       ExtSarStep;
