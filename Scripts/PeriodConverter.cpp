...
//+------------------------------------------------------------------+
#define copyright   "2006-2015, MetaQuotes Software Corp."
#define link        "http://www.mql4.com"
#define description "Period Converter to updated format of history base"
#define strict
#define show_inputs

static int InpPeriodMultiplier=3; // Period multiplier factor
int       ExtHandle=-1;
//+------------------------------------------------------------------+
