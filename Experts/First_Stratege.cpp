...
//|                                              http://www.mql5.com |
//+------------------------------------------------------------------+
#define copyright "Copyright 2010, MetaQuotes Software Corp."
#define link      "http://www.mql5.com"
#define version   "1.00"
//--- input parameters
static int      StopLoss=30;      // Stop Loss
static int      TakeProfit=100;   // Take Profit
static int      ADX_Period=8;     // ADX Period
static int      MA_Period=8;      // Moving Average Period
static int      EA_Magic=12345;   // EA Magic Number
static double   Adx_Min=22.0;     // Minimum ADX Value
static double   Lot=0.1;          // Lots to Trade
//--- Other parameters
